import 'package:afghan_backpack/herat_screens/heratHotelsScreen.dart';
import 'package:afghan_backpack/herat_screens/restaraunts.dart';
            ...
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      // You can add functionality for the heart icon here
                    },
                    child: const CircleAvatar(
                      backgroundColor: Colors.white,
                      child: Icon(
                        Icons.favorite_border, // Use Icons.favorite if you want a filled heart
                        color: Colors.red,
                      ),
                    ),
                  ),
